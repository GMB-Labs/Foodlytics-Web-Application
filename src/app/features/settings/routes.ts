    ...
    children: [
      {
        path: "",
        loadComponent: () =>
          import("./ui/pages/settings.component").then(
        ...
        children: [
          {
            ...
            loadComponent: () =>
              import(
                "./ui/components/account-settings/account-settings.component"
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                "./ui/components/privacy-policy/privacy-policy.component"
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                "./ui/components/terms-conditions/terms-conditions.component"
